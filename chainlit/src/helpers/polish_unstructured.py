...
class PolandHandbookUnstructuredChatMode(ChatMode):
    ...
    async def handle_new_message(self, message):
        ...
        if source_documents:
            for source_idx, source_doc in enumerate(source_documents):
                ...
                source_doc.page_content = source_doc.page_content.replace("Part", "Page")
    ...
    async def on_chat_resume(self, thread):
        print("Resuming polish handbook unstructured chat")
